...
} from '../workspace-member/workspace-member.connection-definition';
import { WorkspaceMember } from '../workspace-member/workspace-member.entity';
import { CreateWorkspaceMemberGroupInput } from './inputs/create-workspace-member-group.input';
import { UpdateWorkspaceMemberGroupInput } from './inputs/update-workspace-member-group.input';
import {
  WorkspaceMemberGroupConnection,
  WorkspaceMemberGroupConnectionArgs,
} from './workspace-member-group.connection-definition';
