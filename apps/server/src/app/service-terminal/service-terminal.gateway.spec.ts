...
describe('ServiceTerminalGateway', () => {
  ...
  it('starts an interactive exec session for the selected service pod', async () => {
    ...
    expect(coreV1Api.listNamespacedPod).toHaveBeenCalledWith({
      ...
      labelSelector:
        'app.kubernetes.io/managed-by=kudeploy,kudeploy.com/workspace=kd-workspace-workspace_1,kudeploy.com/project=kd-project-1,kudeploy.com/service=kd-service-1',
    });
