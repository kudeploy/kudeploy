...
} from '@/app/workspace-member-group/workspace-member-group.connection-definition';
import { CurrentWorkspace } from '@/common/decorators/current-workspace.decorator';
import { CurrentWorkspaceMember } from '@/common/decorators/current-workspace-member.decorator';

import { WorkspaceMemberGroup } from '../workspace-member-group/workspace-member-group.entity';
...
import { CreateServiceAccountWorkspaceMemberInput } from './inputs/create-service-account-workspace-member.input';
