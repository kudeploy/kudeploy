...
const documents: Documents = {
  ...
  "\n  query getRegistryCredentialsFromServiceSettingsRoute($projectId: ID!) {\n    registryCredentials(projectId: $projectId, first: 20) {\n      edges {\n        node {\n          id\n          name\n          registry\n        }\n      }\n    }\n  }\n":
    types.GetRegistryCredentialsFromServiceSettingsRouteDocument,
  "\n  query getVolumesFromServiceSettingsRoute($projectId: ID!) {\n    volumes(projectId: $projectId, first: 100) {\n      edges {\n        node {\n          id\n          name\n          size\n          status\n        }\n      }\n    }\n  }\n":
    types.GetVolumesFromServiceSettingsRouteDocument,
  "\n  mutation updateServiceSettingsFromServiceSettingsRoute(\n    $projectId: ID!\n    $id: ID!\n    $input: UpdateServiceInput!\n  ) {\n    updateService(projectId: $projectId, id: $id, input: $input) {\n      id\n      name\n      image\n      registryCredentialId\n      replicas\n      command\n      args\n      resources {\n        cpuRequest\n        cpuLimit\n        memoryRequest\n        memoryLimit\n      }\n      healthCheck {\n        type\n        port\n        path\n      }\n      ports {\n        port\n        targetPort\n      }\n      env {\n        key\n        value\n      }\n      volumes {\n        volumeId\n        mountPath\n        subPath\n        readOnly\n      }\n      updatedAt\n    }\n  }\n":
