...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceVolume) DeepCopyInto(out *ServiceVolume) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceVolume.
func (in *ServiceVolume) DeepCopy() *ServiceVolume {
	if in == nil {
		return nil
	}
	out := new(ServiceVolume)
	in.DeepCopyInto(out)
	return out
}
